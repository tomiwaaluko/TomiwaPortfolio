    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-amber-700 via-orange-400 to-orange-300 hover:bg-slate-200 text-white">
              {" "}
              Hire Me
            </button>
            <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-amber-700 via-orange-400 to-orange-300 hover:bg-slate-800 text-white mt-3">
              {" "}
